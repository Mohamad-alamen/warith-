...
function Footer() {
  return (
    <div className="bg-[#15313F]">
    <div className="h-[70rem] lg:h-[24rem] w-full max-w-screen-2xl m-auto flex flex-col lg:flex-row lg:flex-row-reverse lg:justify-between lg:relative items-center justify-between">
